    ...
    <div class="span10">
        ...
        <div class="widget-content nopadding">
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="username" class="span11" value="<?php echo $acc[0]["username"]?>" onchange="" placeholder="Masukkan Password Lama" disabled/>
              </div>
          ...
          <!-- <div class="control-group">
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="password" name="password_baru" value="" id="new_pass" onchange="" class="span11" placeholder="Masukkan Password Baru" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="password" name="confirm" id="confirm" value="" class="span11" placeholder="Konfirmasi Password Baru" />
              </div>
            </div>
