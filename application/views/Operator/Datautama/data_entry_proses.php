   ...
   <div class="widget-box" id="tabdata">
          <div class="widget-title">
            <ul class="nav nav-tabs">
               <li><a data-toggle="tab" href="#tab1"  id="aduan">Aduan</a></li>
              <li class="active"><a data-toggle="tab" href="#tab2"  id="proses">Proses</a></li>
                           ...
                           <tr>
                              ...
                              <td style="width:70px"><center><a  id="nomor<?php echo $i; ?>" style="cursor: pointer"><?php echo $entri[$i]["nomor"]; ?></a>
                                <div id="show<?php echo $i?>" hidden>
                                  <table border="0">
                                    <tr>
                                      <td><a href="<?php echo base_url()?>Dataentry/dataProses/edit/<?php echo $entri[$i]['nomor']?>"><button class="btn btn-mini btn-success">LHPK</button></a></td>
                                      <td><a href="<?php echo base_url()?>Dataentry/dataProses/cetakOPK/<?php echo $entri[$i]['nomor']?>"><button class="btn btn-mini btn-primary" style="width: 39px;">OPK</button></a></td>
                                    </tr>
                                    <tr>
                                      <td><a href="<?php echo base_url()?>Dataentry/dataProses/cetakSPK/<?php echo $entri[$i]['nomor']?>"><button class="btn btn-mini btn-warning" style="width: 41px;">SPK</button></a></td>
                                      <td><a href="<?php echo base_url()?>Dataentry/gantiStatus/2/<?php echo $entri[$i]['nomor']?>"><button class="btn btn-mini btn-danger">close</button></a></td>
                                    </tr>
                                  </table>
                               </div>
                              </td>
