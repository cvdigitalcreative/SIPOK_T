...
<!--breadcrumbs-->
 ...
 <div class="container-fluid">
    ...
    <div class="row-fluid">
      <div class="span12">
         <a href="<?php echo base_url()?>Dataentry/riwayat_lawas/<?php echo $inven ?>">Lihat Riwayat Lama</a>
  ...
  $(document).ready(function(){
     ...
     function kirimFilterRiwayat(tahun,bulan){
      ...
      if(tahun=="semua"){
       ...
       window.location.href="<?php echo base_url();?>Dataentry/riwayat/<?php echo $inven?>/"+tahun+"/"+bulan;
     }
