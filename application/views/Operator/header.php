...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" ><a title="" href="<?php echo base_url()?>Operator/ubah_data" ><i class="icon icon-user"></i>  <span class="text"><?php echo $username." (".$tipe.")"; ?></span></a>
    </li>

    <li class=""><a title="" href="<?php echo base_url();?>Operator/1"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a></li>
  </ul>
</div>
